---
title: "Conversion of CN/JP/KR/TW/US to EU"
---
...
2. Insert SD card into **SD1 slot (IMPORTANT!)** of the MIB and install M.I.B. via corresponding key combo
...
4. Check that train is changed to EU:            ![](attachments/fd6ae412-7562-421b-aab9-829f46eff756.png)
5. Download EU firmware (~~IMPORTANT! if available use AIO version~~**- EDIT: do NOT use AIO wtf is this tip?! Use latest available EU fw**) and unpack onto FAT32 formatted SD card
...
6. Insert SD card with the firmware into SD1 slot and install it:
 ...
 ![](attachments/390b94ab-e362-4a9a-9a09-1ddb388d1201.png)
...
:::info
If you got black screen after convertion of **MHI2_KR_AU57x_Sxxx firmware, just connect TTL cable to quadlock, login and delete all update.txt from /net/rcc/mnt/efs-persist/SWDL/ folder.**
:::

## Example of MHI2Q conversion

https://www.drive2.com/b/651860313007718652/
