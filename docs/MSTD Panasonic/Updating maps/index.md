...
:::info
Starting from P106 version maps require 16Gb SD card. Probably you can delete some \*.psf files to make it fit to stock 8Gb card
:::

The latest **available** EU maps on mibsolution.one is **[P106_N60S3MIBS2_EU_NT.7z](https://mibsolution.one/?module=fileman&section=do&page=download&paths%5B%5D=%2FROOT%2F1%2F15%2FMSTD%2FP106_N60S3MIBS2_EU_NT%20(8V0060866S).7z)**\nContent of **DBInfo.txt** file on SD:
...
It is confirmed that P106_N60S3MIBS2_EU_NT maps work on **MSTD_EU_SE_P5310** from original SD card without installing any FEC!  ![](attachments/f158afbe-76a2-46ae-92f2-f465f26c04da.png)
:::
...
2. To have FECs 00040100 (Navigation) and 022000ee or 022000f0 (lifetime EU maps) as **allowed** in "**Activation keys**" of [RED menu](/General information/Audi MMI Tastenkombinationen/):

    ![](attachments/06871fe1-e28b-44c0-8cdf-6afd1c9c3aef.png)
...
`MSTD_AU*` firmwares check every \*.psf file in **\\markets\\eu\\map\\MapRegions\\** folder on the maps SD.


:::warning
Looking at the end of `*.psf`files of P106_N60S3MIBS2_EU_NT maps, you can see that on Audi, Activation key (FEC) `02200030` or higher is required.\n  ![](attachments/3b80989e-721c-46e4-a6f9-f77a5d929843.png)
:::
