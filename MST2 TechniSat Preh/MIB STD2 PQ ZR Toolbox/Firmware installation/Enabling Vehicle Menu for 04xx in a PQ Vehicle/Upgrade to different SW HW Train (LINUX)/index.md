...
## Upgrade procedure
 ...
 1. Connect an SD card reader ([SD Card Readers (working/not working)](/MST2 TechniSat Preh/SD Card Readers (working not working)/)) to the eMMC through-hole plating (soldering or probes). For me the connection was only stable with DATA0 connected and DATA1-3 unconnected (-> slow read & write)
    * eMMC pinout: \n [ ](https://github.com/Feserich/mib2std-zr-firmware-upgrade/blob/master/images/probe_points.jpg)

       ![alt text](https://github.com/Feserich/mib2std-zr-firmware-upgrade/raw/master/images/probe_points.jpg)

      \
    * See [this image](https://www.electroniccircuitsdesign.com/sites/default/files/img/sd-card-pinout.png) for a SD card pinout
    * example of probes soldered to a USB SD card reader (alternative pinout) [ ](https://github.com/Feserich/mib2std-zr-firmware-upgrade/blob/master/images/emmc_with_probes.jpg)

       ![alt text](https://github.com/Feserich/mib2std-zr-firmware-upgrade/raw/master/images/emmc_with_probes.jpg)
 ...
 8. Convert the vmdk file back to a raw disk dump and write it to the eMMC. Execute [this script](https://github.com/Feserich/mib2std-zr-firmware-upgrade/blob/master/scripts/write_vmdk_to_emmc.sh) to do it.
...
## Convert with alternative tools
