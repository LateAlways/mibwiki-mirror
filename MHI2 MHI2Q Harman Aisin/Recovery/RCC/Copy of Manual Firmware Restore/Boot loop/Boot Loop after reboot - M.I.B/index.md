...
Directly after any operation, which ends with an automated reboot from GEM.


It might look like this:

* unit restart after 30-60s
* only boot screen shown
* maybe part of some GUI element, but no response to any buttons
...
Why this is happening some times? Good question!
